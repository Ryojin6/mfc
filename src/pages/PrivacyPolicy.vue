<template>
  <TemplateDefault class="relative">
    <AtomSection class="relative bg-r-charcoal" tp="large" bp="large">
      <AtomInner
        class="prose-white prose prose-lg h-full w-full items-center justify-center !text-white"
      >
        <h2 class="!text-white">Privacy Policy</h2>
        <p>
          Your privacy is important to us. It is Resura policy to respect your
          ...
          our website,
          <span>https://resura.io</span>, and other sites we own and operate.
        </p>
        <p>
        ...
        <h4 class="!text-white">Log Data</h4>
        <p>
        ...
        <h4 class="!text-white">Collection and Use of Information</h4>
        <p>
        ...
        <h4 class="!text-white">How Long We Keep Your Personal Information</h4>
        <p>
        ...
        <h3 class="!text-white">Children’s Privacy</h3>
        <p>
        ...
        <h3 class="!text-white">Limits of Our Policy</h3>
        <p>
